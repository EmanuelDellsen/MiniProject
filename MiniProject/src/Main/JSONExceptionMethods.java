...
class JSONExceptionMethods {

    void checkDate(String dateRetrieved) {
    ...
    void validateProjectId(CharSequence idString) {
    ...
    void validateTaskId(CharSequence taskId) {
    ...
    void checkProjectCompletedDateAfterStart(LocalDate endDate, LocalDate startDate) {
    ...
    void checkTaskEndDatesAfterStart(LocalDate actualStartDate, LocalDate projectedCompletedDate, LocalDate actualCompletedDate) {
    ...
    void validateBudgetAtCompletion(double budgetAtCompletion) {
    ...
    void validateSalaryPerHour(double salaryPerHour) {
        if (salaryPerHour < 0) {
            throw new JSONException("Ooops.... Looks like your salaryPerHour is negative. Please check your JSON-file and try again");
        }
    }

    void validateRiskProbabilityAndImpact(double probability, int impact) {
